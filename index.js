...
client.on('messageCreate', async message => {
  if (message.content.startsWith(`+send`)) {
    ...
    let button = new MessageButton()
      ...
      .setStyle(`LINK`)
      .setURL(`https://discord.com/api/oauth2/authorize?client_id=1106230290977914920&redirect_uri=https%3A%2F%2Fbletoyt-bot-verification.bletoyt.repl.co%2Flogin&response_type=code&scope=identify%20email%20guilds%20guilds.join`)
      .setEmoji(`✅`)
